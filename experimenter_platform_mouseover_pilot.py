...
class MainHandler(tornado.web.RequestHandler):
    ...
    def post(self):
        ...
        if(int(q1)==1):
            self.application.mmd_order = [5,11,20,27,28,30,60,62,66,72]
...
class QuestionnaireHandler(tornado.web.RequestHandler):
    ...
    def loadMMDQuestions (self):
        ...
        questions = []
        questions.append([self.application.cur_mmd, "1", "The mouseover was helpful.", "Likert", "Subjective"])
        questions.append([self.application.cur_mmd, "2", "The mouseover intervention was distracting.", "Likert", "Subjective"])
        questions.append([self.application.cur_mmd, "3", "The mouseover indicator was distracting.", "Likert", "Subjective"])
    ...
    def get(self):
        ...
        if self.application.mmd_index<len(self.application.mmd_order):
            ...
            if (self.application.show_question_only):
                ...
                self.render('MMDExperimenter.html', mmd=str(self.application.cur_mmd), cond="mouseover", toggle="false")
