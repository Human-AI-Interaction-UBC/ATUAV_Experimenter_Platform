...
INSERT INTO "intervention_state" VALUES('legend_intervention',1,1534870269629731,1);
...
INSERT INTO "rule_state" VALUES('legend_9',1534870269629731,1);
CREATE TABLE text_fix ( `id` INTEGER, `time_start` INTEGER, `time_end` INTEGER, `duration` INTEGER, PRIMARY KEY(`id`) );
INSERT INTO "text_fix" VALUES(1,1534870267173490,1534870267414817,241327);
...
INSERT INTO "vis_fix" VALUES(2,1534870268439034,1534870269629731,1190697);
INSERT INTO "vis_fix" VALUES(3,1534870270062789,1534870270370992,308203);
INSERT INTO "vis_fix" VALUES(4,1534870271270225,1534870271386835,116610);
INSERT INTO "vis_fix" VALUES(5,1534870271420080,1534870271544931,124851);
INSERT INTO "vis_fix" VALUES(6,1534870271569933,1534870271753153,183220);
COMMIT;
