...
INSERT INTO "intervention_state" VALUES('legend_intervention',1,1534870095882803,1);
...
INSERT INTO "rule_state" VALUES('legend_27',1534870095882803,1);
CREATE TABLE text_fix ( `id` INTEGER, `time_start` INTEGER, `time_end` INTEGER, `duration` INTEGER, PRIMARY KEY(`id`) );
INSERT INTO "text_fix" VALUES(1,1534870094383890,1534870094650473,266583);
INSERT INTO "text_fix" VALUES(2,1534870094792086,1534870095000177,208091);
INSERT INTO "text_fix" VALUES(3,1534870095016802,1534870095300008,283206);
INSERT INTO "text_fix" VALUES(4,1534870095308383,1534870095591472,283089);
...
INSERT INTO "vis_fix" VALUES(5,1534870095624841,1534870095882803,257962);
INSERT INTO "vis_fix" VALUES(6,1534870095907929,1534870096249128,341199);
INSERT INTO "vis_fix" VALUES(7,1534870096498967,1534870096632216,133249);
INSERT INTO "vis_fix" VALUES(8,1534870097132129,1534870097273484,141355);
COMMIT;
