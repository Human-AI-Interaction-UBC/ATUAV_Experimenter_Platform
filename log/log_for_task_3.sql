...
INSERT INTO "intervention_state" VALUES('legend_intervention',1,1534869987209454,1);
...
INSERT INTO "rule_state" VALUES('legend_60',1534869987209454,1);
CREATE TABLE text_fix ( `id` INTEGER, `time_start` INTEGER, `time_end` INTEGER, `duration` INTEGER, PRIMARY KEY(`id`) );
INSERT INTO "text_fix" VALUES(1,1534869986151969,1534869986951234,799265);
INSERT INTO "text_fix" VALUES(4,1534869988025649,1534869988266914,241265);
INSERT INTO "text_fix" VALUES(5,1534869988275419,1534869988391903,116484);
...
INSERT INTO "vis_fix" VALUES(2,1534869987017844,1534869987209454,191610);
INSERT INTO "vis_fix" VALUES(3,1534869987292682,1534869987983706,691024);
COMMIT;
