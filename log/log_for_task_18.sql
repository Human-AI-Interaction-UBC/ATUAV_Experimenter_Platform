...
INSERT INTO "intervention_state" VALUES('legend_intervention',1,1534870083950618,1);
...
INSERT INTO "rule_state" VALUES('legend_18',1534870083950618,1);
CREATE TABLE text_fix ( `id` INTEGER, `time_start` INTEGER, `time_end` INTEGER, `duration` INTEGER, PRIMARY KEY(`id`) );
INSERT INTO "text_fix" VALUES(1,1534870082385204,1534870082543306,158102);
INSERT INTO "text_fix" VALUES(2,1534870082551692,1534870082701540,149848);
INSERT INTO "text_fix" VALUES(3,1534870082709784,1534870082884778,174994);
INSERT INTO "text_fix" VALUES(4,1534870082901508,1534870083017993,116485);
INSERT INTO "text_fix" VALUES(5,1534870083026238,1534870083201213,174975);
...
INSERT INTO "vis_fix" VALUES(6,1534870083242702,1534870083950618,707916);
INSERT INTO "vis_fix" VALUES(7,1534870083958853,1534870084158702,199849);
INSERT INTO "vis_fix" VALUES(8,1534870084167083,1534870084516785,349702);
INSERT INTO "vis_fix" VALUES(9,1534870085349541,1534870085507640,158099);
COMMIT;
