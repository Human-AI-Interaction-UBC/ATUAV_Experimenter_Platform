...
INSERT INTO "intervention_state" VALUES('legend_intervention',1,1534869835495316,1);
...
INSERT INTO "rule_state" VALUES('legend_62',1534869835495316,1);
CREATE TABLE text_fix ( `id` INTEGER, `time_start` INTEGER, `time_end` INTEGER, `duration` INTEGER, PRIMARY KEY(`id`) );
INSERT INTO "text_fix" VALUES(1,1534869833305241,1534869833430353,125112);
INSERT INTO "text_fix" VALUES(4,1534869835778528,1534869835928380,149852);
INSERT INTO "text_fix" VALUES(5,1534869839109235,1534869839300570,191335);
...
INSERT INTO "vis_fix" VALUES(2,1534869835320466,1534869835495316,174850);
INSERT INTO "vis_fix" VALUES(3,1534869835520185,1534869835653593,133408);
COMMIT;
