...
INSERT INTO "intervention_state" VALUES('legend_intervention',1,1534869975352132,1);
...
INSERT INTO "rule_state" VALUES('legend_72',1534869975352132,1);
CREATE TABLE text_fix ( `id` INTEGER, `time_start` INTEGER, `time_end` INTEGER, `duration` INTEGER, PRIMARY KEY(`id`) );
INSERT INTO "text_fix" VALUES(1,1534869974893953,1534869975010561,116608);
INSERT INTO "text_fix" VALUES(2,1534869975027182,1534869975202156,174974);
INSERT INTO "text_fix" VALUES(4,1534869976009768,1534869976159747,149979);
...
INSERT INTO "vis_fix" VALUES(3,1534869975243644,1534869975352132,108488);
COMMIT;
