...
INSERT INTO "intervention_state" VALUES('legend_intervention',1,1534870114759842,1);
...
INSERT INTO "rule_state" VALUES('legend_30',1534870114759842,1);
CREATE TABLE text_fix ( `id` INTEGER, `time_start` INTEGER, `time_end` INTEGER, `duration` INTEGER, PRIMARY KEY(`id`) );
INSERT INTO "text_fix" VALUES(1,1534870113727245,1534870113860493,133248);
INSERT INTO "text_fix" VALUES(5,1534870115509228,1534870115775690,266462);
INSERT INTO "text_fix" VALUES(6,1534870115833789,1534870116058768,224979);
INSERT INTO "text_fix" VALUES(8,1534870116799780,1534870117008004,208224);
INSERT INTO "text_fix" VALUES(9,1534870117032872,1534870117257844,224972);
INSERT INTO "text_fix" VALUES(10,1534870118881605,1534870119023339,141734);
...
INSERT INTO "vis_fix" VALUES(2,1534870114460013,1534870114759842,299829);
INSERT INTO "vis_fix" VALUES(3,1534870114809713,1534870115126167,316454);
INSERT INTO "vis_fix" VALUES(4,1534870115134427,1534870115467478,333051);
INSERT INTO "vis_fix" VALUES(7,1534870116125386,1534870116350100,224714);
COMMIT;
