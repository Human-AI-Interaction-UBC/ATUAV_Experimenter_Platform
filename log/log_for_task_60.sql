...
INSERT INTO "intervention_state" VALUES('legend_intervention',1,1534870050210346,1);
CREATE TABLE legend_fix ( `id` INTEGER, `time_start` INTEGER, `time_end` INTEGER, `duration` INTEGER, PRIMARY KEY(`id`) );
INSERT INTO "legend_fix" VALUES(11,1534870051359317,1534870051534142,174825);
CREATE TABLE rule_state ( `rule` TEXT, time_stamp INTEGER, occurences INTEGER, PRIMARY KEY(`rule`));
INSERT INTO "rule_state" VALUES('legend_3',1534870050210346,1);
CREATE TABLE text_fix ( `id` INTEGER, `time_start` INTEGER, `time_end` INTEGER, `duration` INTEGER, PRIMARY KEY(`id`) );
INSERT INTO "text_fix" VALUES(4,1534870048311737,1534870048494962,183225);
INSERT INTO "text_fix" VALUES(5,1534870048519829,1534870048653059,133230);
INSERT INTO "text_fix" VALUES(6,1534870049627426,1534870049843905,216479);
...
INSERT INTO "vis_fix" VALUES(1,1534870038751996,1534870038960085,208089);
INSERT INTO "vis_fix" VALUES(2,1534870038968459,1534870039559633,591174);
INSERT INTO "vis_fix" VALUES(3,1534870039659496,1534870039792850,133354);
INSERT INTO "vis_fix" VALUES(7,1534870050093742,1534870050210346,116604);
INSERT INTO "vis_fix" VALUES(8,1534870050260214,1534870050418306,158092);
INSERT INTO "vis_fix" VALUES(9,1534870050426805,1534870050576661,149856);
INSERT INTO "vis_fix" VALUES(10,1534870051067833,1534870051334300,266467);
COMMIT;
